...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="stylesheet" href="{{url('admin/assets/css/style.css').'?v=2'}}">
      @else
       <link rel="stylesheet" href="{{url('admin/assets/css/Rtl.css').'?v=2'}}">
      @endif
     
      <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
      <link rel="stylesheet" href="{{url('admin/vendors/chosen/chosen.min.css')}}">
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg">{{__('messages.orders_pending')}}</p>
      ...
      <script src="{{url('admin/vendors/chosen/chosen.jquery.min.js')}}"></script>
