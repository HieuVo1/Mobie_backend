...
function registeruser() {
  ...
  if (first_name != ""  && email != "" && password != "" && confirm_password != "") {
    ...
    document.getElementById("reg_error_msg").innerHTML = '<div class="col-sm-12"><div class="alert  alert-danger alert-dismissible fade show" role="alert">Please Enter Required Fields<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div></div>';
    document.getElementById("reg_success_msg").style.display = "none";
    document.getElementById("reg_error_msg").style.display = "block";
  }
            ...
            $.ajax({
              ...
              success: function (data) {
                if (data != 0) {
                  ...
                  document.getElementById("totalamount").innerHTML = parseFloat(addco) - parseFloat(price);
                } else {
              ...
              var addco = parseFloat(subtotal) + parseFloat(charg);
              document.getElementById("totalamount").innerHTML = parseFloat(addco) - parseFloat(coupon);
        }
    }
  });
}
    ...
    success: function (data) {
       ...
       if (data.brand.length != 0) { //demo
        ...
        for (var i = 0; i < data.brand.length; i++) {
          if (brand == data.brand[i]["brand_name"]) {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.brand[i]["brand_name"] + '" name="brand" id="brand"  onchange="changeproductlist()" checked><lable>' + data.brand[i]["brand_name"] + '</lable></div>';
            temp=1;
          } else {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.brand[i]["brand_name"] + '" name="brand" id="brand"  onchange="changeproductlist()"><lable>' + data.brand[i]["brand_name"] + '</lable></div>';
      ...
      if (data.subcategory.length != 0) { //demo
        ...
        for (var i = 0; i < data.subcategory.length; i++) {
          if (subcategory == data.subcategory[i]["id"]) {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.subcategory[i]["id"] + '" name="subcategory" id="subcategory'+i+'"  onchange="changeproductlist()" checked><lable>' + data.subcategory[i]["name"] + '</lable></div>';
            temp=1;
          } else {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.subcategory[i]["id"] + '" name="subcategory" id="subcategory'+i+'"  onchange="changeproductlist()"><lable>' + data.subcategory[i]["name"] + '</lable></div>';
        ...
        for (var i = 0; i < data.price.length; i++) {
          if (price ==data.price[i]) {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.price[i] + '" name="pricesel" id="pricesel"  onchange="changeproductlist()" checked><lable>' + data.price[i] + '</lable></div>';
            temp=1;
          } else {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.price[i] + '" name="pricesel" id="pricesel"  onchange="changeproductlist()"><lable>' + data.price[i] + '</lable></div>';
      ...
      if (data.size.length != 0&&size==0) { //demo
        ...
        for (var i = 0; i < data.size.length; i++) {
          if (size ==data.size[i]) {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.size[i] + '" name="sizechk"   onchange="changeproductlist()" checked><lable>' + data.size[i] + '</lable></div>';
            temp=1;
          } else {
            txt = txt + '<div class="check-shop"><input type="radio" class="my-checkbox" value="' + data.size[i] + '" name="sizechk"   onchange="changeproductlist()"><lable>' + data.size[i] + '</lable></div>';
       ...
       if (data.color.length != 0) { //demo
        ...
        for (var i = 0; i < data.color.length; i++) {
          if (color ==data.color[i]) {
            txt = txt + '<li id="changeli'+i+'" onclick="changeactive('+i+')" class="active-1"><input type="radio" id="customcolor'+i+'" name="colorchk" value="'+data.color[i]+'"  class="color-1" style="background:'+data.color[i]+'" onchange="changeproductlist()"></li>';
            temp=1;
          } else {
            txt = txt + '<li id="changeli'+i+'" onclick="changeactive('+i+')"><input type="radio" id="customcolor'+i+'" name="colorchk" value="'+data.color[i]+'"  class="color-1" style="background:'+data.color[i]+'" onchange="changeproductlist()"></li>';
...
function changeqty(val){
    ...
    if(qty>=1){
        ...
        $("#qty-nu").val(qty);
         ...
         document.getElementById("order_price").innerHTML=parseInt(total);
    }
