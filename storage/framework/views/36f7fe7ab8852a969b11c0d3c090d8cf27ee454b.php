                  ...
                  <div class="card-body">
                     ...
                     <form action="<?php echo e(url('admin/updateprofile')); ?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <img src="<?php echo e(asset('upload/profile/'.'/'.$data->profile_pic)); ?>" class="imgsize1" />
                           <div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Mobie\UploadingContentV1.0\PHPScript\PHPScript\resources\views/admin/updateprofile.blade.php ENDPATH**/ ?>