                     ...
                     <div class="cmr1">
                        <div class="form-group col-md-12 paddiv">
                           <div class="col-md-6">
                              ...
                              <input type="text" id="facebook_id" placeholder="Enter  Facebook API ID" class="form-control" name="facebook_id" required value="<?php echo e($data->facebook_id); ?>">
                           </div>
                           <div class="col-md-6">
                              <label for="name" class=" form-control-label">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/ecommerce/resources/views/admin/setting/setting.blade.php ENDPATH**/ ?>