                                ...
                                <div class="row">
                                       <?php if(isset($data[0])): ?>
                                        <div class="col-md-4 banner-1 mrg30">
                                            <img src="<?php echo e(asset('public/upload/offer/image').'/'.$data[0]); ?>" alt="Los Angeles" class="img-responsive">
                                            <div class="banner-text"></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if(isset($data[1])): ?>
                                        <div class=" col-md-4 banner-2 mrg30">
                                            <img src="<?php echo e(asset('public/upload/offer/image').'/'.$data[1]); ?>" alt="Los Angeles" class="img-responsive" >
                                            <div class="banner-text"></div>
                                        </div>
                                        <?php endif; ?>
                                        <?php if(isset($data[2])): ?>
                                        <div class=" col-md-4 banner-2 mrg30">
                                            <img src="<?php echo e(asset('public/upload/offer/image').'/'.$data[2]); ?>" alt="Los Angeles" class="img-responsive">
                                            <div class="banner-text"></div>
                                        </div>
                                        <?php endif; ?>
                                    </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/ecommerce/resources/views/admin/offer/normaloffer.blade.php ENDPATH**/ ?>