...
<html class="no-js" lang="en">
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
      ...
      <link rel="shortcut icon" href="<?php echo e(url('admin/favicon.ico')); ?>">
      ...
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/jqvmap/dist/jqvmap.min.css')); ?>">
      ...
      <link rel="stylesheet" href="<?php echo e(url('admin/assets/css/style.css').'?v=2'); ?>">
      <?php else: ?>
       <link rel="stylesheet" href="<?php echo e(url('admin/assets/css/Rtl.css').'?v=2'); ?>">
      <?php endif; ?>
     
      <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800' rel='stylesheet' type='text/css'>
      <link rel="stylesheet" href="<?php echo e(url('admin/vendors/chosen/chosen.min.css')); ?>">
  ...
  <div class="dropdown-menu" aria-labelledby="bell-button" id="notificationshow">
   <p class="red" id="notificationmsg"><?php echo e(__('messages.orders_pending')); ?></p>
      ...
      <script src="<?php echo e(url('admin/vendors/popper.js/dist/umd/popper.min.js')); ?>"></script>
      ...
      <script src="<?php echo e(url('admin/vendors/chosen/chosen.jquery.min.js')); ?>"></script>
...
</html><?php /**PATH C:\Users\Admin\Desktop\Mobie\UploadingContentV1.0\PHPScript\PHPScript\resources\views/admin/index.blade.php ENDPATH**/ ?>