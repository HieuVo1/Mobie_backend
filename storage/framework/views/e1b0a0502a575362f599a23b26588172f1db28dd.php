                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="category" required id="categorydf" class="form-control">
                                            <option value="0" <?= $attribute->category=='0' ? ' selected="selected"' : '';?>>All Categories</option>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/ecommerce/resources/views/admin/product/editattribute.blade.php ENDPATH**/ ?>