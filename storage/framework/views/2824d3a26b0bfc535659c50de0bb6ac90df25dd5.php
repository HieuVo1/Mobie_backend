                ...
                <div class="col-lg-6 ban col-md-12">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 banner1 b2">
                            <?php // $getImageInfo = getimagesize(asset('public/upload/banner/thumbnail').'/'.$img1);
                        if(empty($img1)){ ?>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="banner2">
                                <?php //$getImageInfo2 = getimagesize(asset('public/upload/banner/thumbnail').'/'.$img2);
                           if(empty($img1)){ ?>
                            ...
                            <div class="banner3 b2">
                                <?php //$getImageInfo3 = getimagesize(asset('public/upload/banner/thumbnail').'/'.$img3);
                           if(empty($img1)){ ?>
                    ...
                    <div class="card">
                        ...
                        <form id="imageUploadForm" action="<?php echo e(url('admin/updatebanner')); ?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-4">
                                        <label for="file-input" class=" form-control-label">Title
                                        </label>
                                    </div>
                                    <div class="col-12 col-md-8">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freaktemplate/public_html/ecommerce/resources/views/admin/banner/default.blade.php ENDPATH**/ ?>